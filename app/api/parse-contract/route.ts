...
- email: correo electronico si aparece (ej: en la clausula de notificaciones); usa "" (vacio) si no aparece.
- phone: telefono de contacto si aparece; usa "" (vacio) si no aparece.

ARRENDATARIO (quien recibe el inmueble en arriendo):
- name: nombre completo
- rut: RUT en formato chileno con puntos y guion
- email: correo electronico si aparece; usa "" (vacio) si no aparece.
- phone: telefono de contacto si aparece; usa "" (vacio) si no aparece.
...
export async function POST(
  ...
  if (!(await dentroDelLimite(...reglasIA("contrato", ipDe(req))))) {
